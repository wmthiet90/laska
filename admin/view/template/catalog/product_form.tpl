  ...
  <div class="box">
    ...
    <div class="content">
      <div id="tabs" class="htabs">
        ...
        <a href="#tab-profile" style="display: none;width:0px;height: 0px;padding: 0px;overflow: hidden;"><?php echo $tab_profile; ?></a>
        <a href="#tab-discount" style="display: none;width:0px;height: 0px;padding: 0px;overflow: hidden;"><?php echo $tab_discount; ?></a>
        <a href="#tab-reward" style="display: none;width:0px;height: 0px;padding: 0px;overflow: hidden;"><?php echo $tab_reward; ?></a>        
      </div>
