  ...
  <div class="box">
    ...
    <div class="content">
      <div id="tabs" class="htabs">
        ...
        <a href="#tab-option"style="display: none;width:0px;height: 0px;padding: 0px;overflow: hidden;"><?php echo $tab_option; ?></a>
        <a href="#tab-image"><?php echo $tab_image; ?></a>
        <a href="#tab-ftp" style="display: none;width:0px;height: 0px;padding: 0px;overflow: hidden;"><?php echo $tab_ftp; ?></a>
        <a href="#tab-mail"style="display: none;width:0px;height: 0px;padding: 0px;overflow: hidden;"><?php echo $tab_mail; ?></a>
        <a href="#tab-fraud" style="display: none;width:0px;height: 0px;padding: 0px;overflow: hidden;"><?php echo $tab_fraud; ?></a>
        <a href="#tab-server"style="display: none;width:0px;height: 0px;padding: 0px;overflow: hidden;"><?php echo $tab_server; ?></a>
      </div>
