<?php
class ControllerCommonRgenPositionsRGenSlideshowFull extends Controller {
		...
		******************************/
        ...
        foreach ($extensions as $extension) {
            ...
            if ($modules) {
            	foreach ($modules as $module) {
            		...
            		if ($module['position'] == 'slideshow_full' && $module['status']) {
        ...
        foreach ($module_data as $module) {
 		...
 		if($this->config->get('config_template') == "rgen-opencart"){
	        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/rgen-positions/rgen_slideshow_full.tpl')) {
	            $this->template = $this->config->get('config_template') . '/template/common/rgen-positions/rgen_slideshow_full.tpl';
	        }
	        $this->render();
        }
    }
