<?php
class ControllerCommonRgenPositionsRGenHeaderBottom extends Controller {
		...
		******************************/
        ...
        foreach ($module_data as $module) {
 		...
 		if($this->config->get('config_template') == "rgen-opencart"){
	        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/rgen-positions/rgen_header_bottom.tpl')) {
	            $this->template = $this->config->get('config_template') . '/template/common/rgen-positions/rgen_header_bottom.tpl';
	        }
	        $this->render();
        }
    }
