<?php
class ControllerCommonRgenPositionsRGenContentTopUpper extends Controller {
		...
		******************************/
        ...
        foreach ($extensions as $extension) {
            ...
            if ($modules) {
            	foreach ($modules as $module) {
            		...
            		if ($module['position'] == 'rgen_content_top_upper' && $module['status']) {
        ...
        foreach ($module_data as $module) {
 		...
 		if($this->config->get('config_template') == "rgen-opencart"){
	        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/rgen-positions/rgen_content_top_upper.tpl')) {
	            $this->template = $this->config->get('config_template') . '/template/common/rgen-positions/rgen_content_top_upper.tpl';
	        }
	        $this->render();
        }
    }
